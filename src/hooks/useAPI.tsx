        ...
        if (typeof e === 'object' && e !== null && 'message' in e) {
            ...
            if(e.message === 'User denied Geolocation' || 'location disabled')
                ...
                presentAlert({
                    ...
                    message: 'Location service/ GPS disabled, kindly enable to use the app.',
                    buttons: [
                      {
                        text: 'Cancel',
                        role: 'cancel',
                      ...
                      },
                      {
                        ...
                        handler: () => {
                            ...
                            Geolocation.requestPermissions() ; //not working
                            getNemazTimes(); //recursive action //not working
                            //code to reload capacitor app
